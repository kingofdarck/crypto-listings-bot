...
class TelegramNotifier:
    ...
    async def send_startup_message(self):
        ...
        message = "🤖 <b>Бот мониторинга предстоящих листингов запущен!</b>\n\n"
        message += "📊 Отслеживаемые биржи:\n"
        message += "• Binance (анонсы)\n• Bybit (анонсы)\n• KuCoin (анонсы)\n\n"
        ...
        message += "🎯 <i>Отслеживаются только анонсированные предстоящие листинги!</i>"
